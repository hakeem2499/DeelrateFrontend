...
export async function Footer() {
    ...
    return (
        <Bounded>
            <footer className="flex flex-col w-full mt-16 lg:mt-24 items-center gap-8 lg:gap-10 justify-between lg:px-0 px-2 py-4">
                {/* Tagline */}
                <div className="text-3xl md:text-5xl px-4">
                    <div className="top-20 left-0 rounded-full dark:bg-slate-100 bg-amber-900 transition-colors duration-200 h-1 m-2 w-1/5" />
                    <em className="text-transparent  bg-clip-text not-italic bg-gradient-to-r font-semibold from-brand to-orange-700 via-brand">
                    ...
                    <div className="flex flex-col gap-4 md:gap-0  md:flex-row justify-between w-full md:items-center">
                        ...
                        <div className="flex justify-center w-full md:w-fit md:justify-between gap-8 items-center">
                            <a href="/contact" className="inline-flex gap-2 items-center ">
                                <span className="mt-1"><ContactIcon /></span>Contact us
                            </a>
                            <a href="/" className="inline-flex gap-2 items-center ">
                                <span className="mt-1"><CareerIcon /></span>Careers
                            </a>
                        </div>
                ...
                <nav aria-label="footer" className="grid grid-cols-2 md:grid-cols-3 gap-8 w-full max-w-6xl py-4 mx-auto md:px-2">
                    ...
                    <div className="flex flex-col md:items-end gap-4">
                        ...
                        {settings.data.contact_information.map((item, index) => (
                            <p key={index || 'contact-item'}>
                                <PrismicText field={item.contact_information} />
                            </p>
                        ))}
