...
export default function ProcessTimeLineClient({ slice }: { slice: Content.ProcessTimeLineSlice }) {
                        ...
                        >
                            ...
                            <div className="relative pl-20 pr-4 md:pl-4 w-full">
                                ...
                                <div className="flex flex-col items-start gap-4">
                                    ...
                                    <PrismicNextImage priority quality={100} className="h-auto rounded-lg  backdrop-blur-sm w-full" field={item.image} />
                                </div>
                            </div>
                        </div>
                    ))}
